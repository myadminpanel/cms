...
if (!function_exists('get_linkedin_login_url'))
{
	function get_linkedin_login_url()
	{
		$CI =& get_instance();
		$CI->load->library('linkedin');
		return $CI->linkedin->login_url();
	}
}


if (!function_exists('get_twitter_login_url'))
{
	function get_twitter_login_url()
	{
		$CI =& get_instance();
		$CI->load->library('twitter');
		return $CI->twitter->login_url();
	}
}
