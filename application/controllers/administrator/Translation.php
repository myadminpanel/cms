...
class Translation extends Administrator_Controller
{
    ...
    public function directory($directory = [])
    {
        ...
        foreach ($directories as $directory) {
            ...
            $folder_href = site_url_multi('admin/translation/directory/' . substr($directory,
    ...
    public function save()
    {
        if ($this->input->post('key')) {
            ...
            if (!empty($file) && file_exists(APPPATH . "language/$file")) {
                ...
                $r = file_put_contents(APPPATH . "language/$file", $f, LOCK_EX);    ///save language file
                if ($r) {
                ...
                redirect(site_url($this->admin_url.'/translation/file/' . $file));
            } else {
