			...
			<div class="row">
				<div class="col-md-9 p-l">
				 ...
				 <div class="col-md-3 p-r">
					{include file="templates/citymap/_partial/sidebar/product_single.tpl"}
				</div>
			</div>
		</div>
	</section>
	{include file="templates/citymap/_partial/related/related_product.tpl"}
	{include file="templates/citymap/_partial/other/other_product.tpl"}
{/block}