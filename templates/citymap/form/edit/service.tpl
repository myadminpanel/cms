								...
								<div class="comment-form">
										...
										<select name="company_id" class="form-control">
											...
											{if $companies}
												{foreach from=$companies item=company}
													<option {if $service->company_id eq $company->id}selected="selected"{/if} value="{$company->id}">{$company->name}</option>
												{/foreach}
											{/if}
										</select>
									</div>
									<div class="form-group">
										...
										<div class="image_container">
											<img id="preview_image" src="{$service->image_preview}" class="image" style="" title="Click and change">
											<input type="file" name="file" accept="image/*" style="display:none">
											<input type="hidden" name="image">
											<div class="image_middle">
												<div class="image_text">Upload</div>
											</div>
										</div>
									</div>
									<div class="form-group">
										<label>{translate('price')}</label>
										<input type="text" name="price" value="{(set_value('price')) ? set_value('price') : $service->price}" class="form-control">
									</div>
									<div class="form-group">
