								...
								<div class="comment-form">
										...
										<select name="company_id" class="form-control">
											...
											{if $companies}
												{foreach from=$companies item=company}
													<option {if $news->company_id eq $company->id}selected="selected"{/if} value="{$company->id}">{$company->name}</option>
												{/foreach}
											{/if}
										</select>
									</div>
									<div class="form-group">
										...
										<div class="image_container">
											<img id="preview_image" src="{$news->image_preview}" class="image" style="" title="Click and change">
