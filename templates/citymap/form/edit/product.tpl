								...
								<div class="comment-form">
										...
										<select name="company_id" class="form-control">
											...
											{if $companies}
												{foreach from=$companies item=company}
													<option {if $product->company_id eq $company->id}selected="selected"{/if} value="{$company->id}">{$company->name}</option>
												{/foreach}
											{/if}
										</select>
									</div>
									<div class="form-group">
										...
										<div class="image_container">
											<img id="preview_image" src="{$product->image_preview}" class="image" style="" title="Click and change">
											<input type="file" name="file" accept="image/*" style="display:none">
											<input type="hidden" name="image" value="{(set_value('image')) ? set_value('image') : $product->image}">
									...
									<div class="form-group">
										...
										<input type="text" name="price" value="{(set_value('price')) ? set_value('price') : $product->price}" class="form-control">
									</div>
									<div class="form-group">
