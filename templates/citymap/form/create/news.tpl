									...
									<div class="tab-content">
										...
										<div class="tab-pane  {if $language.code eq $default_language}active{/if}" id="{$language.code}" role="tabpanel" aria-labelledby="{$language.code}-tab">
											...
											<div class="form-group">
												...
												<textarea class="form-control" id="editor-{$language.id}" name="translation[{$language.id}][description]" value="{set_value('translation[1][name]')}" placeholder="{translate('description')}" class="form-control">{set_value('translation['|cat:$language.id|cat:'][description]')}</textarea>
											</div>
										</div>
										{/foreach}
									</div>
