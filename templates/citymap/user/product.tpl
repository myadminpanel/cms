			...
			<div class="row">
				<div class="col-lg-12 col-md-12 sm-padding-l p-r user-p-exist">
					<ul class="page-tabs nav nav-tabs" role="tablist">
						...
						<li><a class="active" href="{site_url_multi('user/product')}">{translate('product')}</a></li>
					...
					<div class="combo-jumbotron comment-form">
						<div class="comment-form-header">
							<h5>{translate('all_product')}</h5>
							<a href="{site_url_multi('product/add')}"><i class="fas fa-plus"></i> {translate('add_product')}</a>
						</div>
							...
							<table>
								<thead>
									<tr>
										...
										<th>{translate('product_company')}</th>
										<th>{translate('product_status')}</th>
										<th>{translate('product_date')}</th>
										<th>{translate('product_action')}</th>
									</tr>
								</thead>
								<tbody>
									...
									{else}
									<tr>
										<td colspan="5"><div class="alert alert-danger">{translate('product_not_found')}</div></td>
									</tr>
									{/if}
								</tbody>
							</table>
