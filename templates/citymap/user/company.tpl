			...
			<div class="row">
				<div class="col-lg-12 col-md-12 sm-padding-l p-r user-p-exist">
					<ul class="page-tabs nav nav-tabs" role="tablist">
						<li><a class="active" href="{site_url_multi('user/company')}">{translate('company')}</a></li>
					...
					<div class="combo-jumbotron comment-form">
						<div class="comment-form-header">
							<h5>{translate('all_company')}</h5>
							<a href="{site_url_multi('company/add')}"><i class="fas fa-plus"></i> {translate('add_company')}</a>
						</div>
							...
							<table>
								<thead>
									<tr>
										...
										<th>{translate('company_status')}</th>
										<th>{translate('company_date')}</th>
										<th>{translate('company_action')}</th>
									</tr>
								</thead>
								<tbody>
									...
									{else}
									<tr>
										<td colspan="4"><div class="alert alert-danger">{translate('company_not_found')}</div></td>
									</tr>
									{/if}
								</tbody>
							</table>
