			...
			<div class="row">
				<div class="col-md-9 p-l">
					<div class="blog-single">
						...
						<div class="blog-single-text">
							<div class="blog-single-header">
								<h3> {$title} <span class="title_price">{$price} AZN</span></h3>
							</div>
				 ...
				 <div class="col-md-3 p-r">
					{include file="templates/citymap/_partial/sidebar/service_single.tpl"}
				</div>
			</div>
		</div>
	</section>
	{include file="templates/citymap/_partial/related/related_service.tpl"}
	{include file="templates/citymap/_partial/other/other_service.tpl"}
{/block}