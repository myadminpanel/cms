					...
					<div class="thumb">
						...
						<div class="caption-overflow">
							<span>
								...
								<a onclick="returnFileUrl('{$image.href}')" class="btn border-white text-white btn-flat btn-icon btn-rounded ml-5"><i class="icon-link2"></i></a>
							</span>
						</div>
					</div>
...
<script type="text/javascript"><!--
	...
	$('#button-delete').on('click', function(e) {
		if (confirm('{translate('text_confirm')}')) {
			$.ajax({
